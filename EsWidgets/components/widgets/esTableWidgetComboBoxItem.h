...
** @brief 这家伙很懒, 什么都没写
** @details 这家伙很懒, 什么都没写
** @file esTableWidgetComboBoxItem.h
** @date 2025/12/24
** @author 瑶瑶
...
struct TableWidgetComboBoxItemData
{
    QString defaultText;
...
Q_DECLARE_METATYPE(TableWidgetComboBoxItemData)

class EsTableWidgetComboBoxItem  : public QTableWidgetItem
{
public:
    EsTableWidgetComboBoxItem();
    EsTableWidgetComboBoxItem(const QStringList& options = {}, const QString& defaultText = nullptr);
...
private:
    // 设置或获取ComboBox的配置
    void setComboBoxData(const TableWidgetComboBoxItemData& data);
    TableWidgetComboBoxItemData comboBoxData() const;
};
